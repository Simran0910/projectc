...
<br>
   ...
   <div class="container" style="background: white;">  
    ...
    <div class="row">
        ...
        <div class="col-md-4">
               <img src="images\kidnapping\kidnapper.jpg" style="width: 100%; height: 97%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%" >       
        </div>
    </div>
    <div class="row">
<div class="col-md-12">
